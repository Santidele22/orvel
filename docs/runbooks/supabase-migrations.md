...
> Note: Stale recovery sections and the legacy project reference were trimmed on 2026-08-12 because release-2.0 purged the corresponding code paths. See `docs/runbooks/archive/` for historical references.
