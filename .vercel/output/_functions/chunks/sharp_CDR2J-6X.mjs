import { A as AstroError, x as MissingSharp } from './entrypoint_D6LB6xrT.mjs';
import { b as baseService, p as parseQuality } from './generic_CGWuWGJL.mjs';
...
async function loadSharp() {
  let sharpImport;
  try {
    sharpImport = (await import('./index_B5CH_cxu.mjs').then(n => n.i)).default;
  } catch {
