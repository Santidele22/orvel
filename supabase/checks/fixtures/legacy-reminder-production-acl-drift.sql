...
ALTER DEFAULT PRIVILEGES FOR ROLE table_owner IN SCHEMA public GRANT EXECUTE ON FUNCTIONS TO anon, authenticated, service_role;
...
ALTER DEFAULT PRIVILEGES FOR ROLE migration_actor IN SCHEMA public GRANT EXECUTE ON FUNCTIONS TO anon, authenticated, service_role;
