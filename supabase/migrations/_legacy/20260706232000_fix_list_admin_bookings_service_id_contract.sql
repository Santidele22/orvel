-- Align dashboard booking list RPC with the real bookings.service_id contract.
-- Production has public.bookings.service_id as text; returning uuid makes the
-- RPC fail before the dashboard can render confirmed appointments.
