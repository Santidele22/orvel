-- Closed accounts preserve business data but must not continue accepting public bookings.
...
COMMENT ON COLUMN public.businesses.account_closed_at IS
  'Set when account closure completes. Public booking RPCs must reject closed accounts while preserving business records.';
...
BEGIN
  ...
  SELECT b.id, b.account_closed_at
  INTO v_business_id, v_account_closed_at
  FROM public.businesses b
