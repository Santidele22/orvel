...
const LOCAL_LANDING_PORT = '4321';
	...
	const DASHBOARD_SIGN_IN_ROUTE = '/dashboard/auth/login';
...
export function buildCreateAccountBusinessUrl(): string {
  return `${resolveLandingOrigin()}/api/signup/create-account-business`;
}
