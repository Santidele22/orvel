...
import {
  BusinessSettingsFacade,
  BusinessSettingsState,
  WeekdayKey,
  WorkingDayHours
} from '../../../facades/business-settings.facade';
import {
  getVisibleTemplates,
  updateBusinessName,
  type UserBusiness,
...
export class ConfiguracionPage {
  ...
  private readonly facade = inject(BusinessSettingsFacade);
  ...
  readonly savedState = signal<BusinessSettingsState | null>(null);
